...
final class ArticleViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        wrapperView.addSubview(articleListView)
        
        NSLayoutConstraint.activate([
            articleListView.topAnchor.constraint(equalTo: wrapperView.topAnchor),
            articleListView.leadingAnchor.constraint(equalTo: wrapperView.leadingAnchor),
            articleListView.trailingAnchor.constraint(equalTo: wrapperView.trailingAnchor),
            
            articleListView.bottomAnchor.constraint(equalTo: wrapperView.bottomAnchor)
        ])
    }
