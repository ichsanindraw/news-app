...
final class ReportListView: UIView {
    ...
    func updateData(_ newData: [Report]) {
        self.data = newData
    }
}

extension ReportListView: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
